...
def test_haskell():
    ...
    assert names["getInputAndPrint#13"] == [
        "getInputAndPrint",
        "input",
        "getLine",
        "putStrLn",
...
def test_erlang():
    ...
    assert names["public_function#1"] == [
        "public_function",
        "Arg",
        "private_function",
        "Arg",
    ...
    assert names["anonymous_function_demo#3"] == [
    ...
    assert names["recursive_function#9"] == [
        "recursive_function",
        "N",
        "N",
        "recursive_function",
    ...
    assert names["higher_order_function_demo#14"] == [
...
def test_python():
    ...
    assert names["instance_method#7"] == [
        "instance_method",
        "self",
        "value",
        "self",
    ...
    assert names["type_hinted_function#10"] == [
